...
class ListViewActivity : AppCompatActivity() {
    ...
    // 리스트 뷰 어뎁터 구현
    class ListViewAdapter(val carList: MutableList<Car>, val layoutInflater: LayoutInflater, val context: Context) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            // 2. ViewGroup 객체 : 인플레이트된 뷰의 부모 뷰 그룹을 지정 parent
            // 3. attatchToParent : 인플레이트된 뷰를 즉시 부모 뷰 그룹에 추가 할지 여부 (일반적으로 false)
